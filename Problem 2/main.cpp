...
int main() {
    // Campaign last 30 days, 100 voucher will be release, each discount is 30%.
    campaign discountCampaign("CAKE DISCOUNT DAY", 30, 100, 30);
    ...
    while(true) {
        ...
        if(choice == 1) {
            ...
            // Login to system
            Cake.Login(account, password, discountCampaign);
        }
